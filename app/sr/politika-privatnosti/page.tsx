...
const content = privacyContent.sr;

export const metadata: Metadata = {
  title: content.meta.title,
  description: content.meta.description,
  alternates: {
    canonical: `${siteConfig.siteUrl}/sr/politika-privatnosti`,
    languages: {
...
export default function SerbianPrivacyPage() {
  return <PrivacyPage locale="sr" />;
}
